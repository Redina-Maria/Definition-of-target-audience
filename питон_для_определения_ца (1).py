...
# Путь к вашему файлу Excel
file_path = '/content/Данные для кластеризации 1510.xlsx'
...
dbscan = DBSCAN(eps=0.4, min_samples=1, metric='euclidean') # Настройте eps и min_samples в соответствии с вашими данными
